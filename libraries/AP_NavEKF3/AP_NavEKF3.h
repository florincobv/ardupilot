...
#define FLOW_USE_TERRAIN 2
    ...
    const uint16_t hgtAvg_ms = 10;                 // average number of msec between height measurements
    ...
    const uint8_t sensorIntervalMin_ms = 5;        // The minimum allowed time between measurements from any non-IMU sensor (msec)
